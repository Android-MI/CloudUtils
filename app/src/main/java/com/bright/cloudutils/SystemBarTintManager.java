 ...
 * translucent system UI modes. <br/>
 * https://github.com/jgilfelt/SystemBarTint To enable the tint:
 *
 *           ...
 *           setContentView(R.layout.activity_main); // create our manager
 *           instance after the content view is set SystemBarTintManager
 *           tintManager = new SystemBarTintManager(this); // enable status bar
 *           tint tintManager.setStatusBarTintEnabled(true); // enable
 *           navigation bar tint tintManager.setNavigationBarTintEnabled(true);
 *           } <br/>
 *
 *           To provide custom tint color values or drawables:
 *
 *           // set a custom tint color for all system bars
 *           tintManager.setTintColor(Color.parseColor("#99000FF")); // set a
 *           custom navigation bar resource
