package com.bright.cloudutils.reveal;
...
/**
 * A layout which can make some reveal animation which is introduced in material
 * design guideline. <br/>
 * 继承FrameLayout的自定义View，点击页面扩散切换、显隐效果展示。
 *
 * @author Bright-小米
 * @ClassName RevealLayout
 * @Description GitHub: https://github.com/kyze8439690/RevealLayout
 */
