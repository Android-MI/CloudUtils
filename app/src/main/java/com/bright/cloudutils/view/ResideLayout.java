...
/**
 * 侧滑实现，xml布局根布局为 resideLayout，直接子布局只能有2个（Content、menu）<br/>
 * PanelSlideListener接口可监听打开，关闭状态。（onPanelSlide，onPanelOpened，onPanelClosed）<br/>
 *
 * @author Bright-小米
 * @ClassName ResideLayout
 * @Description GitHub源码：https://github.com/kyze8439690/ResideLayout
 */
