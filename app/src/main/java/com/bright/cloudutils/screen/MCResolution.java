...
public class MCResolution {
    ...
    public int getDevHeight(Context context) {
        ...
        if (version == version_13) {
            try {
                result = ((Integer) display.getClass()
                        .getMethod("getRealHeight").invoke(display)).intValue();
            } catch (Exception e) {
                e.printStackTrace();
            }
        ...
        if (version > version_13 && version <= version_16) {
            try {
                result = ((Integer) display.getClass()
                        .getMethod("getRawHeight").invoke(display)).intValue();
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public String getDevScreenSize() {
        return String.valueOf(this.getDevWidth(this.mContext)) + "*"
                + this.getDevHeight(this.mContext);
    }
